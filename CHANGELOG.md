...
- **weather:** Improve layout of current conditions display for better responsiveness ([c686d88](https://github.com/danlourenco/retro-weather/commit/c686d88))
- Add compatibility flags for nodejs support in wrangler configuration ([a2e19e1](https://github.com/danlourenco/retro-weather/commit/a2e19e1))
- Add deploy script to package.json for streamlined deployment process ([b94d3cf](https://github.com/danlourenco/retro-weather/commit/b94d3cf))
- Display application version in the weather information section ([37bd5ec](https://github.com/danlourenco/retro-weather/commit/37bd5ec))
- Add observability configuration to wrangler.jsonc ([152bd95](https://github.com/danlourenco/retro-weather/commit/152bd95))
- Add timestamp property to Observation and NWSObservationResponse interfaces refactor: import WeatherDataItem type in DataGrid component ([e13983c](https://github.com/danlourenco/retro-weather/commit/e13983c))
- Enhance weather data transformation with logging for observation freshness ([cc3fc71](https://github.com/danlourenco/retro-weather/commit/cc3fc71))
- Add timestamp property to ObservationSchema for improved data tracking ([c8713da](https://github.com/danlourenco/retro-weather/commit/c8713da))
...
- Replace onMount with $effect for time and date updates in AppHeader ([087607d](https://github.com/danlourenco/retro-weather/commit/087607d))
...
- Expand guidance for AI coding agents with detailed MCP tools usage ([8d6dda8](https://github.com/danlourenco/retro-weather/commit/8d6dda8))
...
- Update package version to 0.0.3 and upgrade dependencies ([e67c0b9](https://github.com/danlourenco/retro-weather/commit/e67c0b9))
- Update version to 0.0.4 in package.json ([11cea5a](https://github.com/danlourenco/retro-weather/commit/11cea5a))
- Update version to 0.0.5 in package.json and enhance changelog ([db4e7ff](https://github.com/danlourenco/retro-weather/commit/db4e7ff))
- Update version to 0.0.6 in package.json and enhance changelog ([300516d](https://github.com/danlourenco/retro-weather/commit/300516d))
- Update version to 0.0.7 in package.json and enhance changelog ([32fad82](https://github.com/danlourenco/retro-weather/commit/32fad82))
